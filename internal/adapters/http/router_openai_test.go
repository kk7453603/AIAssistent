...
func (f fakeVectorStore) UpdateChunksPayload(context.Context, string, string, map[string]any) error {
	return nil
}
...
func (f *fakeAgentService) SetObsidianVaults(_ []ports.AgentVaultInfo)    {}
